    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @method('PUT')
                ...
                <button type="submit" class="w-auto bg-indigo-500 px-4 py-2 rounded text-gray-200 font-semibold hover:bg-indigo-800 transition duration-200 each-in-out">Guardar</button>
                </div>
            </form>
