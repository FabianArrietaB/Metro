<header>
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        <a class="navbar-brand color-text-nav" href="./" style="color: blue">
            <img src="../img/grupometropolis.png" width="300" heigth="70" alt="">
        </a>
        <div class="collapse navbar-collapse d-none d-sm-none d-md-block" id="navbarSupportedContent">
            ...
            <ul class="btn-group ">
                ...
                <li class="list-inline-item"><a class="g-color-white-opacity-0_8 g-color-primary--hover g-pa-5" href="https://www.instagram.com/ferreteriametropolisdelacosta/" target="_blank"><i class="fab fa-instagram fa-3x"></i></a></li>
